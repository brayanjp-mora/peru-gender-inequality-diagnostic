...
#=====================================================================
#----------------- BOOTSTRAPPED PPDS ANALYSIS -------------------
#=====================================================================
## NOTES: 
## - This takes 29 hours to run. The results are pre-saved in the results folder for convenience.
## - To run the code, you can select everything inside the BOOTSRAPPED PPDS ANALYSIS section
...
#   bootstrap_results <- bootstrap_PPDS(
#     data = dwincome, 
...
# saveRDS(final_summary, "data/analysis_results/PPDS_summary.rds")
#-----------------------------  END ----------------------------------
#=====================================================================


#=====================================================================
#--------------- PPDS GROUP, ANALYSIS AND PROFILE ---------------
#=====================================================================
